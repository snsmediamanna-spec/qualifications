        ...
        <div className="max-w-4xl space-y-12 lg:space-y-16">
          ...
          <div>
            <p 
              ...
              style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
            >
              마이스홍보교육학회(이하 "학회")는 정보주체의 자유와 권리 보호를 위해 「개인정보 보호법」 및 관계 법령이 정한 바를 준수하여, 적법하게 개인정보를 처리하고 안전하게 관리하고 있습니다. 이에 「개인정보 보호법」 제30조에 따라 정보주체에게 개인정보 처리에 관한 절차 및 기준을 안내하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <p 
                ...
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              >
                학회는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li 
                  ...
                  style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
                >
                  교육 서비스 제공: 콘텐츠 제공, 맞춤 서비스 제공, 본인인증, 학습 진도 관리
                </li>
                <li 
                  className="text-base lg:text-lg text-muted-foreground"
                  style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
                >
                  자격증 발급: 자격 심사 및 자격증 발급, 배송 서비스
                </li>
                <li 
                  className="text-base lg:text-lg text-muted-foreground"
                  style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
          ...
          <div>
            ...
            <div className="space-y-4">
              <p 
                ...
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              >
                1. 학회는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.
              </p>
              <p 
                className="text-base lg:text-lg text-muted-foreground leading-relaxed"
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li 
                  ...
                  style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
                >
                  교육 서비스 제공: 서비스 종료 시까지
                </li>
                <li 
                  className="text-base lg:text-lg text-muted-foreground"
                  style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
                >
                  대금 결제 및 재화 등의 공급: 대금 결제 및 재화 등 공급 완료 시까지. 다만, 관계 법령에 따라 보존할 필요가 있는 경우 해당 기간까지 보유
                </li>
              </ul>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <p 
                ...
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              >
                학회는 다음의 개인정보 항목을 처리하고 있습니다.
              </p>
              <div className="bg-muted/30 border border-border p-6 rounded-lg">
                <p 
                  className="text-base lg:text-lg font-medium mb-3 text-foreground"
          ...
          <div>
            ...
            <div className="space-y-4">
              <p 
                ...
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              >
                학회는 원칙적으로 이용자의 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서 처리하며, 이용자의 사전 동의 없이는 본래의 범위를 초과하여 처리하거나 제3자에게 제공하지 않습니다.
              </p>
              <p 
                className="text-base lg:text-lg text-muted-foreground leading-relaxed"
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
          ...
          <div>
            ...
            <div className="space-y-4">
              <p 
                ...
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              >
                학회는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
              </p>
              <div className="bg-muted/30 border border-border p-6 rounded-lg">
                <p 
                  className="text-base lg:text-lg font-medium mb-3 text-foreground"
          ...
          <div>
            ...
            <div className="space-y-4">
              <p 
                ...
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              >
                1. 정보주체는 학회에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li 
                  className="text-base lg:text-lg text-muted-foreground"
              ...
              <p 
                ...
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              >
                2. 제1항에 따른 권리 행사는 학회에 대해 「개인정보 보호법」 시행규칙 별지 제8호 서식에 따라 서면, 전자우편 등을 통하여 하실 수 있으며, 학회는 이에 대해 지체 없이 조치하겠습니다.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <p 
                ...
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              >
                1. 학회는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
              </p>
              <p 
                className="text-base lg:text-lg text-muted-foreground leading-relaxed"
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li 
                  ...
                  style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
                >
                  파기절차: 불필요하게 된 개인정보를 선정하고, 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
                </li>
                <li 
                  className="text-base lg:text-lg text-muted-foreground"
                  style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
          ...
          <div>
            ...
            <div className="space-y-4">
              <p 
                ...
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              >
                학회는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li 
                  className="text-base lg:text-lg text-muted-foreground"
          ...
          <div>
            ...
            <div className="space-y-4">
              <p 
                ...
                style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: '1.8' }}
              >
                학회는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
              </p>
              <div className="bg-muted/30 border border-border p-6 rounded-lg">
                <p 
                  className="text-base lg:text-lg font-medium mb-3 text-foreground"
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="bg-muted/30 border border-border p-4 rounded-lg">
                  <p 
                    className="text-base lg:text-lg font-medium mb-2 text-foreground"
                    style={{ fontFamily: "'Inter', sans-serif" }}
                  >
                    개인정보분쟁조정위원회
                  </p>
